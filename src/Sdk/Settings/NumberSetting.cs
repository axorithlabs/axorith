...
public class NumberSetting : SettingBase
{
    ...
    /// <summary>
    /// Parses the saved string value into a decimal and sets the <see cref="ISettingViewModel.DecimalValue"/> property on the provided ViewModel.
    ...
    {
        vm.DecimalValue = decimal.TryParse(savedValue, NumberStyles.Any, CultureInfo.InvariantCulture, out var d) ? d : DefaultValue;
    }
