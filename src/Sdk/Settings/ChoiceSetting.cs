...
public class ChoiceSetting : SettingBase
{
    ...
    /// <param name="choices">A read-only list of key-value pairs representing the available options. The 'Key' is the stored value, and the 'Value' is the display text.</param>
    ...
    public ChoiceSetting(string key, string label, IReadOnlyList<KeyValuePair<string, string>> choices, string defaultValue, string? description = null) 
