@echo off
echo Packaging Axorith Chrome extension...

REM Define the name of the output zip file
set ZIP_FILE=site-blocker-extension-chrome.zip
...
echo You can now install this file in Chrome via chrome://extensions (Developer mode).
